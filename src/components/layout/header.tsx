  ...
  return (
    ...
    >
      ...
      <div className="w-full px-3 md:px-0">
        <div
          className={cn(
            "container-edge flex items-center justify-between rounded-full border px-4 py-2.5 transition-all duration-500 sm:px-5",
            scrolled || open
              ? "border-line bg-ink/70 backdrop-blur-xl shadow-lg shadow-black/20"
              : "border-transparent bg-transparent [.light_&]:border-line [.light_&]:bg-ink/70 [.light_&]:backdrop-blur-xl [.light_&]:shadow-lg [.light_&]:shadow-black/10",
          )}
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="w-full px-3 md:px-0 lg:hidden"
          >
            <div className="container-edge mt-3 flex flex-col gap-1 rounded-3xl border border-line bg-ink/95 p-5 backdrop-blur-xl">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
